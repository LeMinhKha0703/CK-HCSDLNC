...
interface InviteStudentsModalProps {
  ...
  onClose: () => void;
  groupTitle: string;
  onInviteStudents: (studentEmails: string[]) => void;
}

const InviteStudentsModal: React.FC<InviteStudentsModalProps> = ({ isOpen, onClose, groupTitle, onInviteStudents }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-[600px] p-8 relative">
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-1">Invite Students to {groupTitle}</h2>
          <p className="text-gray-500 text-sm">Onboard your class to start tracking metrics.</p>
        </div>
